...
st.image("immagine_metaboliti.png", caption="Legenda da scrivere", use_column_width=True)
st.write("The distribution can be showed also with boxplots.")
st.image("boxplots_metaboliti.png", caption="Legenda da scrivere", use_column_width=True)
...
st.image("immagine_proteine.png", caption="Legenda da scrivere", use_column_width=True)
st.write("The distribution can be showed also with boxplots.")
st.image("boxplots_proteine.png", caption="Legenda da scrivere", use_column_width=True)
